  ...
  <?php require(RAIZ . '/views/barra_nav.php');?>
      <main class="z-depth-3">
          <div class="contenedor">
                    <h1 class="titulo">Contenido 1/3</h1>
                    ...
                    <form action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']); ?>" method="POST" class="formulario col" name="login" enctype="multipart/form-data" id="formulario"> <!--enctype="multipart/form-data" : para q el form pueda subir archivos -->
                        ...
                        <div class="row dos_campos">
                            <div class="input-field col s6">
                                <h4 class="label_textarea" for="usuario">Nombre y Apellido*</h4>
                            ...
                            <div class="input-field col s6">
                                <h4 class="label_textarea_desactivado" for="correo">Correo electrónico*</h4>
                                <input type="email" name="correo" class="campo tooltipped texto_desactivado" data-position="bottom" data-delay="50" data-tooltip="Este campo no puede modificarse, pongase en contacto con el administrador para solicitar acceso" id="correo" value="<?php if(!$enviado && isset($correo)) { echo $correo; }?>" disabled>
                                <!-- ERROR -->
                        ...
                        <div class="row dos_campos">
                            <div class="input-field col s6">
                                <h4 class="label_textarea" for="password">Contraseña *</h4>
                            ...
                            <div class="input-field col s6">
                                ...
                                <input type="password" name="password2" class="campo tooltipped" data-position="bottom" data-delay="50" data-tooltip="Solo para verificar, vuelva a ingresar la contraseña" id="password2" placeholder="repita contraseña">
                                <!-- ERROR -->
                        ...
                        <div class="row dos_campos">
                            <div class="input-field col s4">
                                <h4 class="label_textarea" for="telefono">Teléfono*</h4>
                            ...
                            <div class="input-field col s6">
                                <h4 class="label_textarea_desactivado" for="dni">DNI*</h4>
                                <input type="text" name="dni" class="campo tooltipped" id="dni" data-position="bottom" data-delay="50" data-tooltip="Este campo no puede modificarse, pongase en contacto con el administrador para solicitar acceso" value="<?php if(!$enviado && isset($dni)) { echo $dni; }?>" disabled>
                                <!-- ERROR -->
