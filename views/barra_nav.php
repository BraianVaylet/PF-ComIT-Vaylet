                  ...
                  <div class="nav-wrapper">
                    <a href="<?php echo RUTA; ?>" class="brand-logo center">WololoW</a>
                      <ul class="left hide-on-med-and-down">
                          <li class="nav_menu_ico"><a class="dropdown-button nav_menu_enlace" href="#!" data-activates="dropdown1"><i class="material-icons">menu</i></a>
                            <?php if (session()): ?>
                              <li class="nav_menu_ico"><a class="dropdown-button nav_menu_enlace" data-activates="dropdown0" href=""><i class="material-icons">person</i></a></li>
                            <?php endif ?>
                      </ul>
                      <ul class="right">
                        <li class="nav_menu_ico"><a class="nav_menu_enlace" href="<?php echo RUTA; ?>/info_personal.php">Acerca de nosotros</a></li>
