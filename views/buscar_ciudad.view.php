  <!-- BUSCADORES =============================================================================== -->
  <div class="row">
    <div class="col s12 m6 l6 z-depth-3 sec_buscar">
        <div class="buscador">
        ...
        <form action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']); ?>" method="POST" class="formulario" name="buscar" enctype="multipart/form-data">
          <div class="col s12 m12 l6 tooltipped" data-position="bottom" data-delay="50" data-tooltip="Seleccione su ciudad">
            ...
            <div class="col s12 m12 l4 boton_buscar">
