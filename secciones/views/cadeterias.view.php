          ...
          ?>
            ...
            <div class="row z-depth-3 box_post">
              ...
              <div class="col s12 m3 l3 monto_post">
                    <div class="servicios">
                      <?php if ($soy_cadete == 1) { ?> <span class="icono_servicio"><i class="medium material-icons activado">directions_bike</i></span> <?php } ?>
                      <?php if ($soy_flete == 1) { ?> <span class="icono_servicio"><i class="medium material-icons desactivado">local_shipping</i></span> <?php } ?>
                    </div>
                    <div class="">
