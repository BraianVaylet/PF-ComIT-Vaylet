  ...
  if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if (empty($dist_min)) {
      // $error_dist_min .= 'Por favor complete el campo DISTANCIA MÍNIMA';
      // $errores = "error";
    }

    if (empty($dist_max)) {
      // $error_dist_max .= 'Por favor complete el campo DISTANCIA MÁXIMA';
      // $errores = "error";
    }

    if (empty($peso_max)) {
      // $error_peso_max .= 'Por favor complete el campo PESO MÁXIMO';
      // $errores = "error";
    }
